...
public class ModelerController extends BaseController {
    ...
    public ModelAndView modelList(HttpServletRequest request, HttpServletResponse response) {
        ModelAndView modelAndView = MVConstructor.MVConstruct();
        TokenCookieHandler.setCookieToken(request,response);
        modelAndView.setViewName(PREFIX+"/modelList");
        return modelAndView;
    }
    ...
    public ModelAndView addModal(HttpServletRequest request, HttpServletResponse response) {
        ModelAndView modelAndView = MVConstructor.MVConstruct();
        TokenCookieHandler.setCookieToken(request,response);
        modelAndView.setViewName(PREFIX+"/modelModal");
        return modelAndView;
    }
